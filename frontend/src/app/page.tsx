...
const LogoIcon = ({ className = "w-8 h-8" }: LogoIconProps) => (
  <svg className={cn("shrink-0 select-none", className)} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3 md:col-span-1">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-baseline font-bold text-xs tracking-wide select-none">
                <span className="text-zinc-350">Talent</span>
                <span className="text-[#D65BB4]">Mind</span>
                <span className="ml-1 text-[7px] px-1 py-0.5 rounded border border-[#22d3ee] text-[#22d3ee] font-extrabold uppercase leading-none self-center">AI</span>
              </div>
            </div>
